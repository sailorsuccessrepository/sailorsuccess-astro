---
title: "Seafarer Tax in India 2026: Complete Income Tax Guide for Merchant Navy"
description: "Complete guide on income tax for Indian seafarers. Learn NRI status, 182-day rule, tax exemptions, ITR filing, TDS on salary, and tax planning strategies."
pubDate: 2026-01-26
...
✅ Days on ship in international waters
✅ Days in foreign ports
✅ Days in foreign countries (shore leave, training)
✅ Transit time in foreign airports
✅ Days ship is in foreign territorial waters

### What Counts as "In India"

❌ Days on ship in Indian ports
❌ Days on ship in Indian territorial waters (12 nautical miles)
❌ Days at home between contracts
❌ Pre-sea training in India
❌ Days in Indian airports
...
**Total outside India:** 96 + 117 + 75 = **288 days**
**Status:** NRI ✅
...
1. Passport (all pages with stamps)
2. CDC with sign-on/sign-off dates
3. Salary certificates from company
4. Form 16 (if TDS deducted)
5. Bank statements (NRE, NRO, savings)
6. Investment proofs
...
**Problem:** Unable to prove NRI status during assessment.
**Solution:** Keep CDC, passport copies, bank statements organized.

### Mistake 2: Depositing in Savings Account

**Problem:** Foreign salary in resident savings account creates tax liability.
**Solution:** Always deposit foreign earnings in NRE account.

### Mistake 3: Ignoring the 182-Day Threshold

**Problem:** Falling short by few days makes entire salary taxable.
**Solution:** Plan shore leave to ensure 182+ days outside.

### Mistake 4: Not Declaring Indian Income

**Problem:** Rental income, FD interest not declared.
**Solution:** File ITR declaring all Indian income even if NRI.

### Mistake 5: Wrong Residential Status Claimed

**Problem:** Claiming NRI status without meeting criteria.
**Solution:** Calculate days accurately. When in doubt, consult CA.
...
2. Claim TDS as refund
3. Provide proof of NRI status
4. Refund processed to bank account
...
3. Respond within given timeframe
4. Provide clear day calculation
5. Submit CDC, passport copies
6. Consult CA if needed
...
1. **ClearTax/Tax2Win** - ITR filing
2. **Excel/Google Sheets** - Day tracking
3. **DigiLocker** - Document storage
4. **Banking apps** - Transaction tracking
...
💼 [Share on LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https://sailorsuccess.online/money/seafarer-tax-guide-india-2026)

---

*Disclaimer: This guide is for educational purposes. Tax laws change frequently. Consult a qualified CA for personal tax advice. Information based on Income Tax Act provisions as of January 2026.*
